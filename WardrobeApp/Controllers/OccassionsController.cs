...
namespace WardrobeApp.Controllers
{
    public class OccassionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccassionID,OccassionType")] Occassion occassion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccassionID,OccassionType")] Occassion occassion)
        {
            if (ModelState.IsValid)
            {
