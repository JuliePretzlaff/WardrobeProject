...
namespace WardrobeApp.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,AccessoryPhoto,AccessoryColor,SeasonID,OccassionID")] Accessory accessory)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occassions, "OccassionID", "OccassionType", accessory.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,AccessoryPhoto,AccessoryColor,SeasonID,OccassionID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
