...
namespace WardrobeApp.Controllers
{
    public class TopsController : Controller
    {
        ...
        {
            var tops = db.Tops.Include(t => t.Occassion).Include(t => t.Season);
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopPhoto,TopColor,SeasonID,OccassionID")] Top top)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occassions, "OccassionID", "OccassionType", top.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopPhoto,TopColor,SeasonID,OccassionID")] Top top)
        {
            if (ModelState.IsValid)
            {
